...
class ViewController: UIViewController{
    ...
    func initUI(){
        //--------------- book background ---------------                                  670
        backImage = UIImageView(frame: CGRect(x: 10, y: 40, width: width - 20, height: 770))
        ...
        //--------------- icon image ---------------     360
        backImage2 = UIImageView(frame: CGRect(x: 150, y: 190, width: 80, height: 80))
        ...
        bienvenidoLabel = UILabel(frame: CGRect(x: 70, y: 280, width: width - 150 , height: 40))
        bienvenidoLabel?.textAlignment = NSTextAlignment.center
        bienvenidoLabel?.backgroundColor = .clear
        bienvenidoLabel?.textColor = darkBlueTextColor
        ...
        //--------------- Correo TXT FIELD---------------
        correoTextField = UITextField(frame: CGRect(x: 30, y: 605, width: width - 60, height: 40))
       ...
       // correoTextField?.endEditing(true)  //endEditing(true)
        ...
        //---------------Encabezado Correo ---------------
        correoLabel = UILabel(frame: CGRect(x: 35, y: 585, width: 50 , height: 15))
        correoLabel?.textAlignment = NSTextAlignment.left
        correoLabel?.backgroundColor = .clear
        correoLabel?.textColor = darkBlueTextColor
      ...
      //---------------Encabezado password ---------------
        pswLabel = UILabel(frame: CGRect(x: 35, y: 650, width: width/5 , height: 15))
        pswLabel?.textAlignment = NSTextAlignment.left
        pswLabel?.backgroundColor = .clear
        pswLabel?.textColor = darkBlueTextColor
        ...
        //--------------- Password ---------------
        pswTextField = UITextField(frame: CGRect(x: 30, y: 670, width: width - 60, height: 40))
        //pswTextField?.text = ""
        ...
        iniciarSesion?.layer.borderColor = UIColor.black.cgColor
        ...
        //--------------- Registrate    ---------------
        registrateButton = UIButton(frame: CGRect(x: 60, y: 765, width: width - 120, height: 40))
...
//MARK: Objeto- Funcion -  BOOKS
    @objc func goToBooks()
                {
                    iniciarSesion?.backgroundColor = blueTextColor
                    iniciarSesion?.alpha = 0.5
                    DispatchQueue.main.asyncAfter(deadline: .now() + 0.2) {
                        self.iniciarSesion?.alpha = 1.0
                        self.iniciarSesion?.backgroundColor = self.darkBlueTextColor
                    }
...
//MARK: Objeto- Funcion - Registro
        @objc func goToRegistro()
        {
           ...
           //Esta funcion cambia el alpha del color y va al principio para que haga el efecto de cambiar al precionar
            registrateButton?.backgroundColor = blueTextColor
